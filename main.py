...
def main():
 ...
 print("RoadsideStation V0.6.12.8.2.2.75 Event-Focused VRUCW starting...")
 ...
 print("V2X Event Engine: %s | VRUCW + AVW + SLW | canonical FusedObjectList input"%("enabled" if event_engine.enabled else "disabled"))
