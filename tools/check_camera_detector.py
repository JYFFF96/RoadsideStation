...
def main():
    parser=argparse.ArgumentParser(description="V0.6.12.8.2.2.50 camera detector preflight")
    ...
    print("Camera detector preflight: READY | detector=%s runtime=%s"%(detector.name,getattr(detector,"runtime","-")))
