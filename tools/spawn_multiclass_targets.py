...
def main():
    parser=argparse.ArgumentParser(description="V0.6.12.8.2.2.57 radar morphology bridge targets")
    ...
    print("V0.6.12.8.2.2.57 targets active: seed=%d walkers=%d road_obstacles=%d walker_mode=%s launch_interval=%.1fs"%(args.seed,len(walkers),len(obstacles),args.walker_mode,args.walker_launch_interval))
    ...
    try:
        ...
        print("V0.6.12.8.2.2.57 test targets removed.")
