...
def main():
    parser=argparse.ArgumentParser(description="V0.6.12.8.2.2.1 deterministic walkers and road obstacles")
    ...
    print("V0.6.12.8.2.2.1 targets active: seed=%d walkers=%d road_obstacles=%d"%(args.seed,len(walkers),len(obstacles)))
    ...
    try:
        ...
        print("V0.6.12.8.2.2.1 test targets removed.")
