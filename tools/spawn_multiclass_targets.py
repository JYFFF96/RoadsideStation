...
def main():
    parser=argparse.ArgumentParser(description="V0.6.12.8.2.2.82 on-demand warning scenarios")
    ...
    print("V0.6.12.8.2.2.82 scenario=%s active: seed=%d walkers=%d road_obstacles=%d stopped_vehicles=%d speeding_vehicles=%d walker_mode=%s launch_interval=%.1fs"%(args.scenario.upper(),args.seed,len(walkers),len(obstacles),len(stopped_vehicles),len(speeding_vehicles),args.walker_mode,args.walker_launch_interval))
    ...
    try:
        ...
        print("V0.6.12.8.2.2.82 test targets removed.")
